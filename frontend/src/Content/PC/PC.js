...
function PC(props){
    ...
    return(
        <div>
            <p> &emsp;It has been a dream of mine to build my own desktop PC. I am fascinated at the intricacy of building PCs, from learning about the different parts, to knowing how to put them together. I’ve heard people say that it is very simple, and it is just plug and play. However, going through the experience of building my own PC has been a rewarding experience, because I learned a lot about computer hardware and the specific details that I learned about each component.</p>
            <p> &emsp;This is what my PC looks like:</p>
            <img alt={'PC Final'} style={{width:'100%',maxWidth:'560px'}} src={`data:image/jpg;base64,${getImage('PC_Final.jpg')}`} />
            <p> &emsp;I built this PC on November of 2021. Before starting the build, I spent time watching Youtube videos and looking into a lot of the PC builds people have created. This Youtube video is the main video that I used as my guide to build my PC. This guide provides the most detailed step-by-step process of building a PC. I highly recommend this video from TechSource. I will go over all the parts that I picked and the things that I’ve learned throughout this experience, and hopefully this will help people when building their own PCs.</p>
            ...
            <p> &emsp;For my parts, I used <a href='https://pcpartpicker.com/list/wn9kvf' target='_blank' rel="noreferrer">PCPartsPicker.com</a>. PC parts picker is a good website because it checks the compatibility of all the components for you. If there is a problem with the parts, such as compatibility, it will tell you at the bottom of the page. It is a very handy tool especially for beginners like me because I don’t know the specifics of each part and how they might not be compatible with each other. Some of the components that I used in this build are not listed on the website because it is not available on the list provided by the website. </p>
            ...
            <img src={`data:image/jpg;base64,${getImage('Ryzen7_CPU.jpg')}`} alt='Ryzen 7 CPU' style={{width:'100%',maxWidth:'240px'}}/> 
            <figcaption>Ryzen 7 3700X</figcaption>

            <p>&emsp;The Central Processing Unit (CPU) is the heart of the computer. It is the part that handles all the general computation of the computer. It would be an understatement to say that this is one of the most important components of the system. Therefore, this would be one of the components that need the utmost thought when building your PC.</p>
            <p>&emsp;For the installation, in my opinion, this is the most nerve-wracking part of the PC building process. The CPU has pins at the bottom that goes into the holes of the CPU mount in the motherboard. Those pins are easily bent if the CPU is placed incorrectly. Both the CPU and the CPU mount have a triangular-shaped indicator. This will align the CPU correctly to the mount. The trick to putting the CPU into the mount is to never use force. The CPU should slide itself into the holes when correctly placed. For me, because it is the most nerve-wracking part, it also gives me great pleasure watching videos of people putting their CPUs into their motherboards.</p>
            ...
            <img src={`data:image/jpg;base64,${getImage('ASUS_TUF_B450_Motherboard.png')}`} alt='ASUS TUF B450 Motherboard' style={{width:'100%',maxWidth:'480px'}}/> 
            <figcaption>ASUS TUFB450-PLUS II Motherboard</figcaption>

            <p>&emsp;The motherboard is the part of the PC that holds everything together. This is where all of the wires and components will be plugged into. Therefore, picking a motherboard is important. There are several questions when picking a motherbord: </p>
            <ol>
            <li>What is the CPU?</li>
            <p> &emsp;This is important because AMD and intel have different sockets, and thus, have different motherboards. The motherboard and the CPU will have to match. </p>
            <li>How many RAM slots is needed?</li>
            <p> &emsp;Typically, motherboards have 4 RAM slots. Some high-end computers have 8 or more RAM slots. </p>
            <li>What is the size of the motherboard?</li>
            <p> &emsp;Motherboards come in different sizes. 
            ...
            <img src={`data:image/jpg;base64,${getImage('Corsair_4000D_PC_Case_.jpg')}`} alt='Corsair 4000D PC Case' style={{width:'100%',maxWidth:'560px', justifyContent:'center'}}/> 
            <figcaption>Corsair 4000D PC Case</figcaption>
            
            <p> &emsp;The case is one of the parts 
            ...
            <img src={`data:image/jpg;base64,${getImage('EVGA_550B5_Power_Supply.jpg')}`} alt='EVGA 550 B5 Power Supply' style={{width:'100%',maxWidth:'240px'}}/> 
            <figcaption>EVGA 550 B5 Power Supply</figcaption>

            <p>&emsp;The power supply provides power 
            ...
            <Grid container spacing={6} sx={{ mt: 0 }}> 
                <Grid item xs={4}>
                <img src={`data:image/jpg;base64,${getImage('860_EVO_M2_SSD.jpg')}`} alt='Samsung 860 Evo M.2 SSD' style={{width:'100%',maxWidth:'240px'}}/> 
                <figcaption>Samsung V-NAND SSD 860 EVO</figcaption>
                </Grid>
                <Grid item xs={6}>
                <img src={`data:image/jpg;base64,${getImage('Teamgroup_1TB_SSD.jpg')}`} alt='Teamgroup SSD' style={{width:'100%',maxWidth:'240px'}}/> 
                <figcaption>TeamGroup AX2 SSD</figcaption>
                </Grid>
            </Grid>

            <p> &emsp;The storage is where the long-term memory is stored. This is where all the files are 
            ...
            <img src={`data:image/jpg;base64,${getImage('Samsung_Odyssey_Monitor.jpg')}`} alt='Samsung Odyssey Monitor' style={{width:'100%',maxWidth:'240px'}}/> 
            <figcaption>Samsung Odyssey 24in monitor</figcaption>

            <p> &emsp;For the monitor, I wanted a 144 Hz refresh rate for my monitor and a slightly curved monitor so I picked up the <b>Samsung Odyssey 24in monitor</b> . </p>
            
            <h2 id='Keyboard'><b><u>Keyboard/Mouse</u></b></h2>

            <img src={`data:image/jpg;base64,${getImage('Heroic_Bundle.jpg')}`} alt='Heroic Bundle' style={{width:'100%',maxWidth:'240px'}}/> 
            <figcaption>Razer Heroic Bundle</figcaption>

            <p> &emsp;I got the <b>Razer Heroic Bundle</b> from Costco. The Razer Heroic Bundle includes the <b>Razer Blackwidow V3</b> keyboad, the <b>Razer DeathAdder V2 Pro</b> mouse, the <b>Razer Gigantus V2 mousepad</b>, and grip tapes. One thing to note about this bundle is I had to return this bundle twice because 
            ...
            <img src={`data:image/jpg;base64,${getImage('JBL_Flip2.jpg')}`} alt='JBL Flip 2' style={{width:'100%',maxWidth:'120px'}}/> 
            <figcaption>JBL Flip 2</figcaption>

            <p> &emsp;For my audio, I am using my <b>JBL Flip 2</b> which I got in 2015 as a credit for trading in my phone. It hasn't been used in a while, so I'm putting it to good use now. 
            </p>

            <h2 id='CPU_Fan'><b><u>CPU Fan</u></b></h2>

            <img src={`data:image/jpg;base64,${getImage('Wraith_Prism_Cooler.jpg')}`} alt='Wraith Prism Cooler' style={{width:'100%',maxWidth:'240px'}}/> 
            <figcaption>Wraith Prism CPU Fan</figcaption>

            <p> &emsp;CPU fans are used to cool the CPU. If the CPU fan is not present, the CPU ca reach 
            ...
            <img src={`data:image/jpg;base64,${getImage('Arctic_P12_PWM_Fan.jpg')}`} alt='Arctic P12 PWM Case Fan' style={{width:'100%',maxWidth:'240px'}}/> 
            <figcaption>Arctic P12 PWM fans</figcaption>

            <p> &emsp;For the case fan, besided the two stock fans provided by the <a href='#Case'>case</a>, I added 3 <b>Arctic P12 PWM fans</b> to the case to provide better airflow. Fans come in multiple sizes. The P12 and the P14 are the most common. According to my research, smaller fans are better because they provide better airflow. </p>
            
            <h2 id='LED'><b><u>LED Lights</u></b></h2>

            <img src={`data:image/jpg;base64,${getImage('LED.jpg')}`} alt='LED' style={{width:'100%',maxWidth:'240px'}}/> 
            <figcaption>LED Strip Light</figcaption>

            <p> &emsp; A friend gave me this <b>LED Strip Light</b> gift for Christmas. Since my motherboard has 4-pin 12V RGB header, I decided to cut half of this and line it inside my PC case. </p>
            
            <h2 id='PCIE'><b><u>PCIe USB-C</u></b></h2>

            <img src={`data:image/jpg;base64,${getImage('PCIE_USBC.jpg')}`} alt='PCIe USB-C' style={{width:'100%',maxWidth:'240px'}}/> 
            <figcaption>PCIe USB-C Card</figcaption>

            <p> &emsp; I got this <b>PCIe USB-C</b> because of the problem I've encountered with the <a href='#Motherboard'>motherboard</a>. The motherboard does not have an USB-C slot which means that my USB-C on my <a href='#Case'>case</a> will be dead. I want to utilize all of my sockets on my case which is why I got the card. This is 
            an altenate solution to the weaknesses of the motherboard that I got. 
            </p>
            
            <h2><b><u>Conclusion</u></b></h2>
            <p> &emsp;I thoroughly enjoyed building my 
